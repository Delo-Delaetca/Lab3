...
Потом начал делать самого агента. До этого я делал LLM с шаблоном ответа, но всё же смог продвинуться дальше и получились файлы: agent_memory.py, llm_agent.py.  
